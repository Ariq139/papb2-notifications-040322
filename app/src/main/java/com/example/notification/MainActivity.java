...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification() {
        ...
        builder.addAction(R.drawable.ic_android_black_24dp, "Learn more", pendingLearnMoreIntent);
        ...
        builder.addAction(R.drawable.ic_android_black_24dp, "Update", pendingUpdateIntent);
    ...
    public void updateNotification() {
        ...
        ////
        Bitmap mascotBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.cat);
        builder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(mascotBitmap).setBigContentTitle("Notif updated"));
